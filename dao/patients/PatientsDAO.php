    ...
    class PatientsDAO {
            ...
            $rs = $db->Execute(
                "SELECT *
                    FROM patients WHERE patients.id_string NOT IN (
                        ...
                        WHERE (
                            (patients_chatbot.pregunta = 8 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text IS NOT NULL) AND
        ...
        public function getAlarm_2_1() {
            ...
            $rs = $db->Execute(
                "SELECT * FROM patients JOIN patients_chatbot 
                    ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 2 AND patients_chatbot.cuestionario = 3 AND patients_chatbot.text = 'Sí') AND
        ...
        public function getAlarm_2_2() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 3 AND patients_chatbot.cuestionario = 3 AND patients_chatbot.text = 'Sí') AND
        ...
        public function getAlarm_2_3() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 4 AND patients_chatbot.cuestionario = 3 AND patients_chatbot.text = 'Sí') AND
        ...
        public function getAlarm_2_4() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 1 AND patients_chatbot.cuestionario = 3 AND patients_chatbot.text = 'Sí') AND
        ...
        public function getAlarm_3_1() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 2 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text = 'peor') AND
        ...
        public function getAlarm_4_1() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 10 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text = 'YES') AND
        ...
        public function getAlarm_4_2() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 9 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text = 'menos') AND
        ...
        public function getAlarm_4_3() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 7 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text = 'SÍ') AND
        ...
        public function getAlarm_4_4() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 6 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text = 'SÍ') AND
        ...
        public function getAlarm_5_1() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 5 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text = 'SÍ') AND
        ...
        public function getAlarm_5_2() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 4 AND patients_chatbot.cuestionario = 1 AND patients_chatbot.text = 'SÍ') AND
        ...
        public function getAlarm_edema() {
            ...
            $rs = $db->Execute(
                ...
                ON patients.id = patients_chatbot.user_id
                WHERE (
                    (patients_chatbot.pregunta = 1 AND patients_chatbot.cuestionario = 1 AND (patients_chatbot.text = 'peor' || patients_chatbot.text = 'igual') ) AND
