                            ...
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_4_d1 = utf8_encode($patients_chatbot_respuesta_1_4[0]);
                                        $respuesta_1_4_d2 = utf8_encode($patients_chatbot_respuesta_1_4[1]);
                                        $respuesta_1_4_d3 = utf8_encode($patients_chatbot_respuesta_1_4[2]);
                                       ...
                                       ?>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_4[0], 2); ?>><?php echo $arpsf_p4[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_4[1], 2); ?>><?php echo $arpsf_p4[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_4[2], 2); ?>><?php echo $arpsf_p4[2]; ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_5_d1 = utf8_encode($patients_chatbot_respuesta_1_5[0]);
                                        $respuesta_1_5_d2 = utf8_encode($patients_chatbot_respuesta_1_5[1]);
                                        $respuesta_1_5_d3 = utf8_encode($patients_chatbot_respuesta_1_5[2]);
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_5[0], 2); ?>><?php echo $arpsf_p5[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_5[1], 2); ?>><?php echo $arpsf_p5[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_5[2], 2); ?>><?php echo $arpsf_p5[2]; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_6_d1 = utf8_encode($patients_chatbot_respuesta_1_6[0]);
                                        $respuesta_1_6_d2 = utf8_encode($patients_chatbot_respuesta_1_6[1]);
                                        $respuesta_1_6_d3 = utf8_encode($patients_chatbot_respuesta_1_6[2]);
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_6[0], 2); ?>><?php echo $arpsf_p6[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_6[1], 2); ?>><?php echo $arpsf_p6[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_6[2], 2); ?>><?php echo $arpsf_p6[2]; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_7_d1 = utf8_encode($patients_chatbot_respuesta_1_7[0]);
                                        $respuesta_1_7_d2 = utf8_encode($patients_chatbot_respuesta_1_7[1]);
                                        $respuesta_1_7_d3 = utf8_encode($patients_chatbot_respuesta_1_7[2]);
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_7[0], 2); ?>><?php echo $arpsf_p7[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_7[1], 2); ?>><?php echo $arpsf_p7[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_7[2], 2); ?>><?php echo $arpsf_p7[2]; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_8_d1 = utf8_encode($patients_chatbot_respuesta_1_8[0]);
                                        $respuesta_1_8_d2 = utf8_encode($patients_chatbot_respuesta_1_8[1]);
                                        $respuesta_1_8_d3 = utf8_encode($patients_chatbot_respuesta_1_8[2]);

                                        // echo "Respuesta_1_8_d1: $respuesta_1_8_d1<br>";
                                        // echo "Respuesta_1_8_d2: $respuesta_1_8_d2<br>";
                                        // echo "Respuesta_1_8_d3: $respuesta_1_8_d3<br>";
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_8[0], 2); ?>><?php echo $arpsf_p8[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_8[1], 2); ?>><?php echo $arpsf_p8[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_8[2], 2); ?>><?php echo $arpsf_p8 [2]; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_9_d1 = utf8_encode($patients_chatbot_respuesta_1_9[0]);
                                        $respuesta_1_9_d2 = utf8_encode($patients_chatbot_respuesta_1_9[1]);
                                        $respuesta_1_9_d3 = utf8_encode($patients_chatbot_respuesta_1_9[2]);
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_9[0], 2); ?>> <?php echo $arpsf_p9[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_9[1], 2); ?>> <?php echo $arpsf_p9[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_9[2], 2); ?>> <?php echo $arpsf_p9[2]; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_10_d1 = utf8_encode($patients_chatbot_respuesta_1_10[0]);
                                        $respuesta_1_10_d2 = utf8_encode($patients_chatbot_respuesta_1_10[1]);
                                        $respuesta_1_10_d3 = utf8_encode($patients_chatbot_respuesta_1_10[2]);
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_10[0], 2); ?>><?php echo $arpsf_p10[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_10[1], 2); ?>><?php echo $arpsf_p10[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_10[2], 2); ?>><?php echo $arpsf_p10[2]; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_11_d1 = utf8_encode($patients_chatbot_respuesta_1_11[0]);
                                        $respuesta_1_11_d2 = utf8_encode($patients_chatbot_respuesta_1_11[1]);
                                        $respuesta_1_11_d3 = utf8_encode($patients_chatbot_respuesta_1_11[2]);
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_11[0], 2); ?>><?php echo $arpsf_p11[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_11[1], 2); ?>><?php echo $arpsf_p11[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_11[2], 2); ?>><?php echo $arpsf_p11[2]; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        $respuesta_1_12_d1 = utf8_encode($patients_chatbot_respuesta_1_12[0]);
                                        $respuesta_1_12_d2 = utf8_encode($patients_chatbot_respuesta_1_12[1]);
                                        $respuesta_1_12_d3 = utf8_encode($patients_chatbot_respuesta_1_12[2]);
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_12[0], 2); ?>><?php echo $arpsf_p12[0]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_12[1], 2); ?>><?php echo $arpsf_p12[1]; ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_1_12[2], 2); ?>><?php echo $arpsf_p12[2]; ?>
                                        </td>
                                    </tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_2[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_2[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_2[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_2[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_2[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_2[2]); ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_3[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_3[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_3[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_3[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_3[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_3[2]); ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_4[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_4[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_4[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_4[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_4[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_4[2]); ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_5[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_5[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_5[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_5[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_5[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_5[2]); ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_6[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_6[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_6[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_6[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_2_6[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_2_6[2]); ?>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_1[0],2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_1[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_1[1],2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_1[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_1[2],2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_1[2]); ?>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_2[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_2[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_2[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_2[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_2[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_2[2]); ?>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_3[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_3[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_3[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_3[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_3[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_3[2]); ?>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_4[0], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_4[0]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_4[1], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_4[1]); ?>
                                        </td>
                                        <td>
                                            <p class = <?php echo fcolor ($patients_chatbot_respuesta_3_4[2], 2); ?>><?php echo utf8_encode($patients_chatbot_respuesta_3_4[2]); ?>
                                        </td>
                                    </tr>
